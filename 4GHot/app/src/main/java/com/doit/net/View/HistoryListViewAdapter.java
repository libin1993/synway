...
//        });
    ...
    public void fillValues(int position, View convertView) {
        ...
        TextView text_data = (TextView)convertView.findViewById(R.id.tvUeidItemText);

        DBUeidInfo resp = ueidList.get(position);
        text_data.setText("IMSI:"+resp.getImsi()+"\n"+"手机号:"+ ImsiMsisdnConvert.getMsisdnFromLocal(resp.getImsi())+"\n"+mContext.getString(R.string.lab_rpt_time)+ DateUtil.convert2String(resp.getCreateDate(),DateUtil.LOCAL_DATE));
