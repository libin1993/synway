...
public class ProtocolManager {
    ...
    public static void setNowTime(){
        ...
        UtilBaseLog.printLog("当前时间：" + sdf.format(d));
    ...
    public static void setCellConfig(String gpsOffset,String pci, String tacPeriod, String sync){
        ...
        UtilBaseLog.printLog("set cell config:" +configContent);
...
//        configContent += HOLD_VALUE;
        ...
        UtilBaseLog.printLog("设置通道: " + configContent);
    ...
    private static String checkPa(String idx, String ga) {
        ...
        if (tmpGa == null || tmpGa.length != 3){
            UtilBaseLog.printLog("len "+tmpGa.length);
            return ga;
        }
...
//        }
        ...
        UtilBaseLog.printLog("设置黑名单(中标)号码: " + configContent);
    ...
    public static void setRTImsi(boolean onOff){
        ...
        UtilBaseLog.printLog("设置是否上报中标号码: " + (onOff?"1":"0"));
    ...
    public static void setLocImsi(String imsi){
        ...
        UtilBaseLog.printLog("下发开始定位："+imsi);
...
//                    }
                    ...
                    if (Integer.valueOf(channel.getGa()) <= 8)
                        defaultGa = String.valueOf(Integer.valueOf(channel.getGa()) * 5);
                    break;
...
//                    }
    ...
    public static void setFancontrol(String maxFanSpeed, String minFanSpeed, String tempThreshold){
        ...
        UtilBaseLog.printLog("设置风扇控制 " + configContent);
